            ...
            {page === "..." ? (
              ...
              <button
                ...
                className={`
                  ...
                  ${
                    currentPage === page
                      ? "bg-emerald-500/80 border-emerald-400/50 text-white shadow-lg shadow-blue-500/25 scale-105"
                      : "bg-white/10 border-emerald-400/20 text-emerald-500 hover:bg-white/20 hover:border-emerald-400/30 hover:scale-105 active:scale-95"
                  }
                `}
